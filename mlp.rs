...
fn print_usage() {
    println!("MLP - Multi-Layer Perceptron");
    println!();
    println!("Usage: mlp <command> [options]");
    println!();
    println!("Commands:");
    ...
    println!();
    println!("Examples:");
    println!("  mlp create -i 2 -H 8 -o 1 -s xor.json");
    println!("  mlp create --input=2 --hidden=8,8 --output=1 --save=xor.json");
    println!("  mlp train -m xor.json -d data.csv -s xor_trained.json --epochs=1000");
    println!("  mlp train --model=xor.json --data=data.csv --epochs=1000 --save=xor_trained.json --verbose");
    println!("  mlp predict -m xor_trained.json -i 1,0");
    println!("  mlp info -m xor_trained.json");
    println!();
    println!("Exit codes:");
    println!("  0 - Success");
    println!("  1 - Error");
